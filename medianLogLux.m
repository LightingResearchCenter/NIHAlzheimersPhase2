function medianLogLux( varargin )
...
if nargin > 1
    ...
    xlsxPath = fullfile(tablesDir,['median_log10Illuminance_',timestamp,'.xlsx']);
end
...
for iObj = 1:nObj
    ...
    medianLogLux(iObj,:) = (objArray(iObj).hourly(log10(objArray(iObj).Illuminance), 'median', lux10idx))';
...
T = table(id, group, session, protocol, medianLogLux);
