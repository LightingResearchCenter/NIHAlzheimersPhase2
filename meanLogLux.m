...
if nargin > 1
    ...
    xlsxPath = fullfile(tablesDir,['mean_log10Illuminance_',timestamp,'.xlsx']);
end
...
for iObj = 1:nObj
    ...
    meanLogLux(iObj,:) = (objArray(iObj).hourly(log10(objArray(iObj).Illuminance), 'mean', lux10idx))';
...
T = table(id, group, session, protocol, meanLogLux);
