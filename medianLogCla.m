function medianLogCla( varargin )
...
if nargin > 1
    ...
    xlsxPath = fullfile(tablesDir,['median_log10CircadianLight_',timestamp,'.xlsx']);
end
...
for iObj = 1:nObj
    ...
    medianLogCla(iObj,:) = (objArray(iObj).hourly(log10(objArray(iObj).CircadianLight), 'median', lux10idx))';
...
T = table(id, group, session, protocol, medianLogCla);
