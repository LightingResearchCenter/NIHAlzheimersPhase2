...
if nargin > 1
    ...
    xlsxPath = fullfile(tablesDir,['median_cs_',timestamp,'.xlsx']);
end
...
for iObj = 1:nObj
    ...
    medianCS(iObj,:) = (objArray(iObj).hourly(objArray(iObj).CircadianStimulus, 'median', lux10idx))';
...
T = table(id, group, session, protocol, medianCS);
