function complianceArray = adjustcrop2(timeArray,complianceArray)
%ADJUSTCROP2 Summary of this function goes here
%   Detailed explanation goes here

noncomplianceArray = ~complianceArray; % noncompliance
...
for i1 = 1:nStarts
    ...
    durationSteps = cropStopArray(i1) - cropStartArray(i1);
